...
import {
  ...
  PODCAST_RSS_URL,
  PODCAST_SPOTIFY_URL, PODCAST_YOUTUBE_URL
} from '@/config'
...
<template>
  <div v-if="PUBLISHED" class="icon-items">
    ...
    <div v-if="PODCAST_YOUTUBE_URL !== null">
      <a :href="PODCAST_YOUTUBE_URL" target="_blank">
        <Tooltip message="En Youtube">
          <Icon class="icon-item icon" weight="light" icon="youtube-logo" />
        </Tooltip>
      </a>
    </div>
