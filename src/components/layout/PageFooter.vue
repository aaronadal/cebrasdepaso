...
const showMoreAudioSources = ref(false);
</script>
      ...
      <div class="container">
        <div class="info">
          <div>
            ...
            <div class="icon-items">
              ...
              <template v-if="showMoreAudioSources">
                <div>
              ...
              <div v-else>
                <Tooltip message="Más...">
                  <Icon style="cursor:pointer;" class="icon-item icon" weight="light" icon="dots-three" @click="showMoreAudioSources = true" />
                </Tooltip>
              </div>
            </div>
          </div>
              ...
              <div>
                <a :href="`mailto://${CONTACT_EMAIL}`" target="_blank">
                  <Tooltip message="Por Email">
                    <Icon class="icon-item icon" weight="light" icon="envelope-simple" />
                  </Tooltip>
                </a>
              </div>
              <div>
        ...
        <nav class="legal-links">
          ...
          <div>
            <router-link
              class="link"
              href="/aviso-legal#toc-politica-de-privacidad"
              :to="{name: 'legal', hash: '#toc-politica-de-privacidad'}">
          ...
          <div>
            <router-link
              class="link"
              href="/aviso-legal#toc-politica-de-cookies"
              :to="{name: 'legal', hash: '#toc-politica-de-cookies'}">
                Política de cookies
            </router-link>
          </div>
        </nav>
